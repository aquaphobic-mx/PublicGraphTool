...
const init_phones = ["Δ Headphones.com (IEM) DF Target", "Truthear Pure (Crystal 2, 2 Gray)"],// Optional. Which graphs to display on initial load. Note: Share URLs will override this set
...
const targets = [
    { type:"Δ",             files:["Δ 5128 DF", "Δ JM-1 DF", "Δ Headphones.com (IEM) DF", "Δ ISO 11904-1 DF", "IEF Comp", "711 to 5128", "711 to 5128 (DD Bass)"] },
...
const  preference_bounds_name = "Bounds",              // Preference bounds name
       ...
       tiltableTargets = ["Δ 5128 DF", "Δ JM-1 DF", "Δ Headphones.com (IEM) DF", "Δ ISO 11904-1 DF", "4128 DF "],                 // Targets that are allowed to be tilted
...
function watermark(svg) {
    ...
    wmSq.append("text")
        ...
        .text("squig.link/lab/aquaphobic");
}
